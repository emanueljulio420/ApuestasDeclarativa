...
public class Apuesta {
    ...
    public static void Apuestaa(ArrayList<Equipos> equipo){
        Random random = new Random();
        int aleatorio = random.nextInt(equipo.size());
        int aleatorio2 = random.nextInt(equipo.size());
        while (aleatorio==aleatorio2){
            aleatorio2 = random.nextInt(equipo.size());
        }
        int aleatorio3 = random.nextInt(equipo.size());
        int aleatorio4 = random.nextInt(equipo.size());
        while (aleatorio3 == aleatorio4){
            aleatorio4 = random.nextInt(equipo.size());
        }
        String aleatorios1 = equipo.get(aleatorio).getNombre();
        String aleatorios2 = equipo.get(aleatorio2).getNombre();
        String aleatorios3 = equipo.get(aleatorio3).getNombre();
        String aleatorios4 = equipo.get(aleatorio4).getNombre();
        ...
        if (eleccion == 1){
            while (eleccion2 != 1 && eleccion2!=2){
                ...
                if (eleccion2 != 1 && eleccion2!=2){incorrecto();}
            }
        }
        else {
            while (eleccion2 != 1 && eleccion2!=2){
        ...
        if (eleccion == 1){
            if (ganador == 1){
                ...
                int ant = equipo.get(aleatorio).getVictorias();
                int der = equipo.get(aleatorio2).getDerrotas();
                equipo.get(aleatorio).setVictorias(ant + 1);
                equipo.get(aleatorio2).setDerrotas(der+1);
            }
            else {
                System.out.println("El equipo ganador es: "+aleatorios2);
                int ant = equipo.get(aleatorio2).getVictorias();
                int der = equipo.get(aleatorio).getDerrotas();
                equipo.get(aleatorio2).setVictorias(ant + 1);
                equipo.get(aleatorio).setDerrotas(der+1);
            }
            ...
            if (ganador == 1){
                ...
                int ant = equipo.get(aleatorio3).getVictorias();
                int der = equipo.get(aleatorio4).getDerrotas();
                equipo.get(aleatorio3).setVictorias(ant + 1);
                equipo.get(aleatorio4).setDerrotas(der+1);
            }
            else {
                System.out.println("El equipo ganador es: "+aleatorios4);
                int ant = equipo.get(aleatorio4).getVictorias();
                int der = equipo.get(aleatorio3).getDerrotas();
                equipo.get(aleatorio4).setVictorias(ant + 1);
                equipo.get(aleatorio3).setDerrotas(der+1);
            }
            if (eleccion2==ganador){
                apuesta = apuesta * 2;
                Main.Plata += apuesta;
